...
useEffect(() => {
  ...
  if (searchInput === '') {
    ...
    let results =employees.filter(
      ...
      employee.EmployeeName.toLowerCase().includes(searchInput) ||
      employee.CodeID.toLowerCase().includes(searchInput) 
...
<div className="col d-flex justify-content-center">
  ...
  <h5 className="card-title">All Employees Details</h5>
  ...
  <tbody>
    {results.map((user,index)=>(
      ...
      {/* <Link className="edit" to={`/update/${user._id}`} > */}
        ...
        <th></th>
        <th scope="col">
      <Link className="delete" onClick={()=>deleteEmployee(user._id)}>
    ...
    <table>
            <tr><th>
            <a href="/add" button type="submit" className="btn btn-success">Add Employee</a></th>
            <th></th>
